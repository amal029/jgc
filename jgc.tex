...
\begin{lrbox}{\baone}
  \begin{minipage}[b]{0.5\linewidth}
    \begin{algo}
      \SetKwData{Let}{let}
      \SetKwFunction{Steptwo}{Step2}
      \SetKwFunction{SortDescending}{sortDescending}
      ...
      \ForEach{$(size,dd) \in defs$} {
        ...
        \ForEach {$d \in dd$} {
          \Let $allocPtr \leftarrow allocPtr - (size + header\_size)$\;
          \lIf {$allocPtr < 0$} {\texttt{raise No\_mem}}\;
  ...
  \begin{minipage}[b]{0.5\linewidth}
    \begin{algo}
      ...
      \uElseIf {$pp = \mathtt{newarray}$} {
        \Let $arg \leftarrow$ \GetArg($pp$)\;
        \uIf {$arg = \mathtt{Basic}$} {
          \ReplaceNewA($pp$,$M$,$arg$)\;
        }\lElse {\ReplaceNewAA($pp$,$M$,$arg$)\;}
        \AdjConditionals($M$,22)\;
      }
      \lElse {\texttt{raise error}}
    \end{algo}
