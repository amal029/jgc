...
\begin{abstract}
  ...
  {\color{red} SystemJ is a programming language based on the
...
ModelSim, {\color{red} performing cycle-accurate simulation of the
...
{\color{red} The exact same micro-benchmarks, all written in Java, are
...
{\color{red} All benchmarks are written in SystemJ, and only the backend
